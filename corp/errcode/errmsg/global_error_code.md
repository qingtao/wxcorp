...
| 40057 | 不合法的callbackurl或者callbackurl验证失败 | 可自助到[开发调试工具](https://work.weixin.qq.com/api/devtools/devtool.php)重现 |
...
| 72023 | 发票已被其他公众号锁定 | [查看帮助](#10649/错误码：72023) |
...
3）设置应用可见范围，仅支持注册定制化安装情况，详情见：[设置授权应用可见范围](#11729/设置授权应用可见范围)
- ##### 错误码：50001
...
- ##### 错误码：84014
成员票据过期。确认：
1）user_ticket 有时效性，有效时长由expires_in指定。参考接口：[根据code获取成员信息](#10028/根据code获取成员信息)
